...
values
    ((select id from category where name = '시계/주얼리'),
     '오메가 아쿠아테라 쿼츠 36mm 은판', 1800000, '서울 강남', true,
     '중고 · 가벼운 흠집',
     '정기적으로 관리한 제품입니다. 보증서와 케이스 포함, 직거래 및 안전결제 모두 가능합니다.',
     'https://picsum.photos/seed/omega/400/300',
     ARRAY['https://picsum.photos/seed/omega1/1200/900','https://picsum.photos/seed/omega2/1200/900','https://picsum.photos/seed/omega3/1200/900'],
     now() - interval '2 days'),
